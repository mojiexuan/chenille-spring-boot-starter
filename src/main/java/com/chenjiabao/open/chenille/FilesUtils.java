...
import com.chenjiabao.open.chenille.dto.FileStatus;
...
public class FilesUtils {
    ...
    private final com.chenjiabao.open.chenille.model.property.File fileProperty;
    private final TimeUtils timeUtils;
    private final StringUtils stringUtils;

    public FilesUtils(com.chenjiabao.open.chenille.model.property.File fileProperty, TimeUtils timeUtils, StringUtils stringUtils) {
    ...
    public boolean createDirectory(File dir) {
        ...
        if (!dir.exists()) {
            ...
            if (parentFile != null && !parentFile.exists() && !createDirectory(parentFile)) {
                return false; // 如果父目录创建失败，返回false
            }
            // 创建当前目录
            return dir.mkdirs(); // 如果当前目录不存在，尝试创建它
        }
        return true; // 如果目录已经存在，直接返回true
    }
