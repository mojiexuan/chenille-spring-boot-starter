...
import com.chenjiabao.open.chenille.html.ChenilleMailHtmlTemplate;
import jakarta.mail.*;
 ...
 * @author ChenJiaBao
 */
public class ChenilleMailUtils {
    ...
    private ChenilleMailUtils(Session session, String brand){
        this.session = session;
        this.brand = brand;
    }

    public ChenilleMailUtils setFrom(String address){
        this.from = address;
        return this;
    }

    public ChenilleMailUtils setTo(String address){
        this.to = address;
        return this;
    }

    public ChenilleMailUtils setSubject(String subject){
     ...
     * @return MailUtils
     */
    public ChenilleMailUtils setContent(String content){
    ...
    public boolean sendSystemNotice(String title,String call,String content,String writer){
        try{
            this.setContent(renderTemplate(ChenilleMailHtmlTemplate.getSystemNoticeTemplate(), Map.of(
                    "title", title,
                    "call", call,
                    "content", content,
                    "writer", writer,
    ...
    public static class Builder {
        ...
        public Builder(ChenilleCheckUtils chenilleCheckUtils) {
        ...
        public Builder setHost(String host) {
            if (chenilleCheckUtils.isValidEmptyParam(host)) {
        ...
        public Builder setProtocol(String protocol) {
            if (chenilleCheckUtils.isValidEmptyParam(protocol)) {
         ...
         * @return MailUtils实例
         */
        public ChenilleMailUtils build() {
            if (chenilleCheckUtils.isValidEmptyParam(this.host)) {
                throw new IllegalArgumentException("SMTP服务器地址不能为空");
            }
            ...
            Session session;
            if (this.auth) {
                if (chenilleCheckUtils.isValidEmptyParam(this.username, this.password)) {
            ...
            return new ChenilleMailUtils(session,brand);
        }
    }
}
